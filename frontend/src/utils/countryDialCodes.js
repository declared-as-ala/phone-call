const _COUNTRY_DIAL_CODES_RAW = [
  { name: "Afghanistan", iso: "AF", flag: "🇦🇫", dialCode: "+93" },
  { name: "Aland Islands", iso: "AX", flag: "🇦🇽", dialCode: "+358" },
  { name: "Albania", iso: "AL", flag: "🇦🇱", dialCode: "+355" },
  { name: "Algeria", iso: "DZ", flag: "🇩🇿", dialCode: "+213" },
  { name: "American Samoa", iso: "AS", flag: "🇦🇸", dialCode: "+1" },
  { name: "Andorra", iso: "AD", flag: "🇦🇩", dialCode: "+376" },
  { name: "Angola", iso: "AO", flag: "🇦🇴", dialCode: "+244" },
  { name: "Anguilla", iso: "AI", flag: "🇦🇮", dialCode: "+1" },
  { name: "Antigua and Barbuda", iso: "AG", flag: "🇦🇬", dialCode: "+1" },
  ...
  { name: "Bermuda", iso: "BM", flag: "🇧🇲", dialCode: "+1" },
  ...
  { name: "British Virgin Islands", iso: "VG", flag: "🇻🇬", dialCode: "+1" },
  ...
  { name: "Caribbean Netherlands", iso: "BQ", flag: "🇧🇶", dialCode: "+599" },
  { name: "Cayman Islands", iso: "KY", flag: "🇰🇾", dialCode: "+1" },
  ...
  { name: "Dominica", iso: "DM", flag: "🇩🇲", dialCode: "+1" },
  { name: "Dominican Republic", iso: "DO", flag: "🇩🇴", dialCode: "+1" },
  ...
  { name: "Eswatini", iso: "SZ", flag: "🇸🇿", dialCode: "+268" },
  ...
  { name: "Grenada", iso: "GD", flag: "🇬🇩", dialCode: "+1" },
  { name: "Guadeloupe", iso: "GP", flag: "🇬🇵", dialCode: "+590" },
  { name: "Guam", iso: "GU", flag: "🇬🇺", dialCode: "+1" },
  { name: "Guatemala", iso: "GT", flag: "🇬🇹", dialCode: "+502" },
  { name: "Guernsey", iso: "GG", flag: "🇬🇬", dialCode: "+44" },
  ...
  { name: "Isle of Man", iso: "IM", flag: "🇮🇲", dialCode: "+44" },
  { name: "Israel", iso: "IL", flag: "🇮🇱", dialCode: "+972" },
  { name: "Italy", iso: "IT", flag: "🇮🇹", dialCode: "+39" },
  { name: "Jamaica", iso: "JM", flag: "🇯🇲", dialCode: "+1" },
  { name: "Japan", iso: "JP", flag: "🇯🇵", dialCode: "+81" },
  { name: "Jersey", iso: "JE", flag: "🇯🇪", dialCode: "+44" },
  ...
  { name: "Macau", iso: "MO", flag: "🇲🇴", dialCode: "+853" },
  ...
  { name: "Montserrat", iso: "MS", flag: "🇲🇸", dialCode: "+1" },
  ...
  { name: "North Macedonia", iso: "MK", flag: "🇲🇰", dialCode: "+389" },
  { name: "Northern Mariana Islands", iso: "MP", flag: "🇲🇵", dialCode: "+1" },
  ...
  { name: "Palestine", iso: "PS", flag: "🇵🇸", dialCode: "+970" },
  ...
  { name: "Pitcairn Islands", iso: "PN", flag: "🇵🇳", dialCode: "+64" },
  { name: "Poland", iso: "PL", flag: "🇵🇱", dialCode: "+48" },
  { name: "Portugal", iso: "PT", flag: "🇵🇹", dialCode: "+351" },
  { name: "Puerto Rico", iso: "PR", flag: "🇵🇷", dialCode: "+1" },
  ...
  { name: "Saint Kitts and Nevis", iso: "KN", flag: "🇰🇳", dialCode: "+1" },
  { name: "Saint Lucia", iso: "LC", flag: "🇱🇨", dialCode: "+1" },
  { name: "Saint Martin", iso: "MF", flag: "🇲🇫", dialCode: "+590" },
  { name: "Saint Pierre and Miquelon", iso: "PM", flag: "🇵🇲", dialCode: "+508" },
  { name: "Saint Vincent and the Grenadines", iso: "VC", flag: "🇻🇨", dialCode: "+1" },
  ...
  { name: "Sint Maarten", iso: "SX", flag: "🇸🇽", dialCode: "+1" },
  ...
  { name: "Vatican City", iso: "VA", flag: "🇻🇦", dialCode: "+39" },
...
function prioritizeCountryDialCodes(list) {
  const priorityIsos = ["US", "IT", "DE", "KW", "TN"];
  const copy = [...list];
  const head = [];
  for (const iso of priorityIsos) {
    const i = copy.findIndex((c) => c.iso === iso);
    if (i >= 0) {
      head.push(copy[i]);
      copy.splice(i, 1);
    }
...
/** USA first, then Italy / Germany / Kuwait / Tunisia, then all other countries A–Z. */
export const COUNTRY_DIAL_CODES = prioritizeCountryDialCodes(_COUNTRY_DIAL_CODES_RAW);
